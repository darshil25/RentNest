...
export default function Home() {
  ...
  const viewProperty = async (location="") => {
   
        let data = {
          location: location,
        };
        
		var response = await fetchDataPrivate("post", "admin/viewPropertyList", data);
		
		if(response.status === 200){
      for (let i = 0; i < response.data.length; i++) {
        console.log(bb + response.data[i]["image"]);
        response.data[i]["image"] = bb + response.data[i]["image"];
          ...
          <SwiperSlide>
            <div className="swiper-slide">
              ...
              <div className="content-overlay m-5 p-5 col-4">
                <div
                  className={`slide-desc-col ${
                    activeSlideIndex == 0 ? "show" : ""
                  } animated fadeInDown slide-desc-1 `}
                >
                  <div className="row bg-white p-4 col-lg-12">
                    <div className="col-lg-6">
                      <h3 className="font-weight-bold">Location:-</h3>
                      <select value={selectedValue} onChange={selectdatachange}>
          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-6 col-lg-3">
                <div
                  className="feature wow fadeInLeft sample_property_div"
                  id="feature1"
                >
                  <div className="feature-icon center-block smaple_property_div_icn">
                    <i className="fa fa-building"></i>
                  </div>
                  <div className="feature-text">
                    <h5 className="subtitle-margin">Avoid Brokers</h5>

                    <div className="title-separator center-block feature-separator"></div>
                    <p>
                      We directly connect you to verified owners to save
                      brokerage
                    </p>
                  </div>
                </div>
              ...
              <div className="col-sm-6 col-lg-3">
                <div className="feature wow fadeInUp" id="feature2">
                  ...
                  <div className="feature-text">
                    <h5 className="subtitle-margin">Free Listing</h5>
                    <div className="title-separator center-block feature-separator"></div>
              ...
              <div className="col-sm-6 col-lg-3">
                <div className="feature wow fadeInUp" id="feature3">
                  ...
                  <div className="feature-text">
                    <h5 className="subtitle-margin">Shortlist without Visit</h5>
              ...
              <div className="col-sm-6 col-lg-3">
                <div className="feature wow fadeInRight" id="feature4">
                  ...
                  <div className="feature-text">
                    <h5 className="subtitle-margin">Rental Agreement</h5>
        ...
        <section className="section-light bottom-padding-45 section-top-shadow">
          <div className="container">
            <div className="row">
              <div className="col-xs-12 col-sm-9">
                ...
                <h1>
                  new listings<span className="special-color">.</span>
                </h1>
              </div>
          ...
          <div className="grid-offers-container row col-lg-12 d-flex justify-content-center">
            ...
            {propertydata.map((propertydata) => (
              //  <Carousel.Item>
              <div className="grid-offer-col col-3" key={propertydata.id}>
          ...
          <div className="container">
            <div className="row">
              <div className="col-xs-12 col-lg-12">
                ...
                <h1 className="">
                  our blog<span className="special-color">.</span>
                </h1>
              </div>
            ...
            <div className="row">
              <div className="col-md-12 col-lg-6 blog-grid1-left-col">
                <article className="blog-grid1-item zoom-cont">
                  <figure className="text-center">
                    <Link to="">
                      <img src={blog_grid1a} alt="" className="zoom" />
                    </Link>
                    <br />
                    <button className="pt-2 pb-2 p-4 mt-4 read_more_link">
                      Read More
                    </button>
                  </figure>
                  <div className="blog-grid1-post-content">
                    <div className="blog-grid1-topline">
                      <div className="blog-grid1-author pull-left">
                        <i className="fa fa-user"></i>Admin
                      </div>
                      <div className="blog-grid1-date pull-right">
                        <i className="fa fa-calendar-o"></i>28/09/15
                      </div>
                      <div className="clearfix"></div>
                    </div>
                    <Link to="" className="blog-grid1-title">
              ...
              <div className="col-md-12 col-lg-6 blog-grid1-right-col">
                <article className="blog-grid1-item zoom-cont">
                  <figure className="text-center">
                    <Link to="">
                      <img src={blog_grid1b} alt="" className="zoom" />
                    </Link>
                    <button className="pt-2 pb-2 p-4 mt-4 read_more_link">
                      Read More
                    </button>
              ...
              <div className="col-md-12 col-lg-6 blog-grid1-left-col">
                <article className="blog-grid1-item zoom-cont">
                  ...
                  <figure className="text-center">
                    <Link to="">
                      <img src={blog_grid1e} alt="" className="zoom" />
                    </Link>
                    <button className="pt-2 pb-2 p-4 mt-4 read_more_link">
                      Read More
                    </button>
              ...
              <div className="col-md-12 col-lg-6 blog-grid1-right-col">
                <article className="blog-grid1-item zoom-cont">
                  ...
                  <figure className="text-center">
                    <Link to="">
                      <img src={blog_grid1d} alt="" className="zoom" />
                    </Link>
                    <button className="pt-2 pb-2 p-4 mt-4 read_more_link">
                      Read More
                    </button>
