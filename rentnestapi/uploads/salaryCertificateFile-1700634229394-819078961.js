...
export default function Forgotpassword() {
	...
	useEffect(() => {
	  ...
	  const forgotPasswordApi = async () => {
    	...
    	var response = await fetchData("public/forgetPassword",data);
							...
							<div className="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
								...
								<div className="form w-100">
									...
									<div className="fv-row mb-8">
										{/* <!--begin::Email--> */}
										<input type="text" placeholder="Email" name="email" className="form-control bg-transparent" value={email}  onChange={(e) => setEmail(e.target.value)} />
										{/* <!--end::Email--> */}
									</div>
									{/* <!--begin::Actions--> */}
									<div className="d-flex flex-wrap justify-content-center pb-lg-0">
										<button className="btn me-4 btnButton" onClick={() => {forgotPasswordApi()}}>
